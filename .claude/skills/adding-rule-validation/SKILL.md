...
description: Guide for adding new YAML linting rules to pg2sqlite-rs. Use when implementing a new validation rule, creating a linting feature, or when the user mentions adding rules like "truthy", "comments", "braces", etc.
---

# Adding New Validation Rules

This skill provides step-by-step guidance for implementing new YAML linting rules in the pg2sqlite-rs project.
